...
import minecraft.phoenix.scienceExp.proxy.ClientProxy;
 ...
 * 
 */
public class BlockFluidGas extends BlockFluidFinite
{
    public BlockFluidGas(int id, Fluid fluid, Material material)
    {
    ...
    {
    	return ClientProxy.blockRenderGas.getRenderId();
    }
}
